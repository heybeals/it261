...
<div id="wrapper">
    <div id="hero">
    <img src="images/towerofgod.jpeg" alt="Tower of God Anime">
    </div>
<!--end hero-->
<main>
    <h1>Welcome to my Webpage!</h1>
    <h2>Evidence of the php skills I'm learning</h2>
    <p>Crack Jennys tea cup Pieces of Eight scuppers six pounders pillage execution dock crimp rutters transom cable. Cackle fruit sloop scurvy rum aft sheet hulk Brethren of the Coast rutters hearties. Landlubber or just lubber bucko provost grog blossom aft lass cable loot swab swing the lead.

    Interloper Sail ho pillage yawl broadside quarterdeck lateen sail warp pirate Privateer. Chain Shot knave chandler lookout bilge chantey salmagundi yardarm bilged on her anchor nipperkin. Yellow Jack maroon plunder lad hearties fluke six pounders heave to gangway gangplank.</p>
    <h2>I like to use funny ipsum</h2>
