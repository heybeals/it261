...
switch ($today) {
    ...
    case 'Monday':
        ...
        $content = '<p><b><em>Married at First Sight</em></b> is a series in it\'s 16th season, whereby a 
    ...
    case 'Tuesday':
        ...
        $alt = 'Mythic Quest';
        $content = '<p><b><em>Mythic Quest</em></b> is a series, in it\'s 3rd season, which follows a fictional video game studio that produces Mythic Quest, 
        a popular MMORPG, run by the game\'s creator and creative director Ian Grimm. At the start of the series, the studio is about to release a major 
        expansion pack to the game, titled Raven\'s Banquet. Grimm argues with lead engineer Poppy Li, head of monetization Brad Bakshi, and head writer C.W. Longbottom.</p>';
        break;
    ...
    case 'Friday':
        ...
        spread about humanity and a mysterious experiment, they seek to discover the world\'s secrets.</p>';
        break;
    ...
    case 'Saturday':
        ...
        $content = '<p><b><em>Drag Race</em></b> is a series in it\'s 15th season, where drag queens from across the country face off in feats of fashion, acting, 
        comedy and more in hopes of winning the title of America\'s Next Drag Superstar.</p>';
        break;
}
